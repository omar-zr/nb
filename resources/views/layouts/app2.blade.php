...
<head>
    ...
    <title>{{ config('HEVEN', 'HEVEN') }}</title>
...
<link href="{{ URL::asset('css/css/font-style.css') }}" rel="stylesheet">
<link href="{{ URL::asset('css/css/flexslider.css') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {{-- <a href=" "  style="margin:50%"> عطورونا </a>
                    <a href="" style=";margin:50%;margin-left:150%">  الأنواع</a> --}}
